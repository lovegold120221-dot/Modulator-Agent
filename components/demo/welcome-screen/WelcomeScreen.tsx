...
const welcomeContent: Record<Template, { title: string; description: string; prompts: string[] }> = {
  ...
  'modulator': {
    title: 'Modulator Agent',
    description: 'Advanced intent-detection and prompt-generation orchestrator.',
    prompts: [
      'Make me a poster for a coffee shop.',
        ...
        <div className="title-container">
          ...
          <div className="title-selector">
            <select value={template} onChange={(e) => setTemplate(e.target.value as Template)} aria-label="Select a template">
              ...
              <option value="modulator">Modulator Agent</option>
            </select>
